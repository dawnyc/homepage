...
我的研究方向主要是**计算机视觉**、**多模态深度学习**和**生成式深度学习**，近期主要关注**视觉语言模型（VLM）**、**生成式模型（AIGC）**、**目标跟踪（VOT / VLT）**。

## 最新消息 🔥
 * [ <u>2026.02.02</u> ] 🎉 我们在视觉语言跟踪领域的工作 **GLAD** 被 IJCV 期刊接收！ [arXiv](https://arxiv.org/abs/2602.00570) 预印版论文和 [项目主页](https://github.com/Confetti-lxy/GLAD) 已经公布。
 ...
 * <u>2024.7 - 至今</u>：多模态算法工程师。
   - 字节跳动 - Data - 国际电商 - 治理与体验，上海市
   - 主要致力于国际化电商平台的商品内容安全治理相关的多模态大模型的研究与应用工作。技术栈包括混合专家模型、强化学习、表征学习、蒸馏和Agent技术。
 * <u>2023.6 - 2023.9</u>：计算机视觉算法工程师实习生。
   - 阿里集团 - 淘天集团 - 阿里妈妈，杭州市。
   - 主要致力于多模态算法和 AIGC 算法的研发与优化工作。技术栈包括对比学习和扩散模型。

## 荣誉与奖项 🏅
 * 2026年，字节跳动-Data-国际电商**SpotBonus奖项**（电商多模态大模型技术探索和业务落地）。
